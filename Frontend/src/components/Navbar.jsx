...
function navbar() {
    ...
    const navItem = (<>
        ...
        <li>
            <a href='/newspapper' >News Papper</a>
        </li>
        <li>
            <a href='/newarrival'>New Arrival</a>
        </li>
        <li>
            <a href='/book'>Books Issue</a>
        </li>
        <li>
    ...
    return (
        <>
            <div className={`  mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 dark:bg-slate-900 dark:text-white 
            ${
